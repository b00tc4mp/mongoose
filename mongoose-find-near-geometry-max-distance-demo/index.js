...
// city.index({ location: '2dsphere' }, { unique: true, background: false })

// WARN following index creation from mongoose schema does not work 
// city.index({ location: '2dsphere' }/*, { unique: true, background: false, sparse: true }*/)
// MUST create index manually in mongo shell to make it work
